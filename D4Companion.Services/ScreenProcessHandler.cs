    ...
    public class ScreenProcessHandler : IScreenProcessHandler
    {
        ...
        private bool FindTooltips(Bitmap currentScreenBitmap)
        {
            ...
            var tooltipImagesFiltered = _settingsManager.Settings.ControllerMode ?
                _imageListItemTooltips.Keys.Where(t => (t.StartsWith("tooltip_gc_", StringComparison.OrdinalIgnoreCase) || t.StartsWith("tooltip_kb_", StringComparison.OrdinalIgnoreCase)) && _systemPresetManager.IsControllerActive(t)) :
                _imageListItemTooltips.Keys.Where(t => t.StartsWith("tooltip_kb_", StringComparison.OrdinalIgnoreCase));
